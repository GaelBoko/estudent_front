  ...
  implements OnInit
{
    ...
    this.subs.sink = dialogRef.afterClosed().subscribe((result) => {
      if (result === 1) {
        ...
        this.exampleDatabase.dataChange.value.unshift(
          this.departmentsService.getDialogData()
        );
        this.refreshTable();
  ...
  removeSelectedRows() {
    ...
    this.selection.selected.forEach((item) => {
      ...
      this.refreshTable();
      this.selection = new SelectionModel<Departments>(true, []);
    });
    this.showNotification(
      'snackbar-danger',
  ...
  public loadData() {
    this.exampleDatabase = new DepartmentsService(this.httpClient);
  ...
  // context menu
  onContextMenu(event: MouseEvent, item: Departments) {
...
export class ExampleDataSource extends DataSource<Departments> {
  ...
  connect(): Observable<Departments[]> {
    ...
    this.exampleDatabase.getAllDepartmentss();
